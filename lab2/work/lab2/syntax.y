...
%%
Program : ExtDefList    { $$ = make_node(yylineno,5,"Program");treeNode N_list[1]={$1};link_node($$,1,N_list);if(0) print_tree($$,0);if(is_wrong == 1) return;table = initTable(); sementic_process($$); deleteTable(table);}
        ;
